...
BOARD_BOOTIMAGE_PARTITION_SIZE := 33554432         # 65536     * 512 (mmcblk0p35)
BOARD_RECOVERYIMAGE_PARTITION_SIZE := 33554432     # 65536     * 512 (mmcblk0p20)
BOARD_SUPER_PARTITION_SIZE := 6794772480           # 13271040  * 512 (mmcblk0p45)
BOARD_CACHEIMAGE_PARTITION_SIZE := 209715200       # 409600    * 512 (mmcblk0p48)
BOARD_CACHEIMAGE_FILE_SYSTEM_TYPE := ext4
BOARD_DTBOIMG_PARTITION_SIZE := 8388608            # 16384     * 512 (mmcblk0p36)
BOARD_USES_METADATA_PARTITION := true
BOARD_ROOT_EXTRA_FOLDERS += metadata

BOARD_MAIN_SIZE := 125074145280
...
# Inherit the proprietary files (Doesn't exist - 26 Feb 2024)
